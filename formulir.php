...
if (isset($_POST['submit'])) {
    ...
    if($nama == "" || $tgl == "" || $jumlah == "") {
        ...
        mysqli_query($db," INSERT INTO lapangan (nama, tgl, jumlah) VALUES ('$nama', '$tgl', '$jumlah')");
...
<div class="form">
            <h1>Formulir Pemesanan Lapangan</h1>
            <form method="post" enctype="multipart/form-data">
                <table class="pendaftaran">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="jumlah" id="jumlah"  placeholder="Masukkan Jumlah Jam" class="input"  value="<?php echo isset($_POST['jumlah']) ? $_POST['jumlah'] : ''; ?>">
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">
