            ...
            <form method="post" enctype="multipart/form-data">
                <table class="pendaftaran">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="number" name="jumlah" id="jumlah" required placeholder="Masukkan Jumlah Jam" class="input" value="<?php echo $data['jumlah'] ?>" disabled>
                        </td>
                    </tr>
                    <tr>
                        <th colspan="2">
